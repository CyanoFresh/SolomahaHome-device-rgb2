...
void onMqttConnect(bool sessionPresent) {
  ...
  // Subscribe
  mqttClient.subscribe("rgb/room1-rgb2/set", 0);
  mqttClient.subscribe("devices/room1-rgb2", 0);
  ...
  mqttClient.publish("rgb/room1-rgb2", 0, false, sendPayload.c_str());
}
...
void setup() {
  ...
  mqttClient.setClientId("room1-rgb2");
  mqttClient.setCredentials("1", "fdlknjdfgljhnvfdjldshljkfsdkbjljbdssfdwfe");
